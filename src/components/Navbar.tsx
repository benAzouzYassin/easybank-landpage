function Navbar() {
    return (
        <div className="h-16 w-full z-100 flex flex-row lg:pl-36  items-center shadow-md bg-white pl-10 pr-10 relative">
            ...
            <div className="hidden lg:flex flex-row h-full gap-5 ml-24 text-gray-400 font-semibold ">
            ...
            <button className="bg-[url('images/icon-hamburger.svg')] bg-cover bg-center ml-auto w-6 h-1/4 scale-125 lg:hidden"></button>
        </div>
    )
}
