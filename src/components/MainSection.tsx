...
function MainSection() {
    return (
        <div className='h-[90vh] scro relative lg:pl-36 w-full flex flex-row overflow-x-hidden'>
            ...
            <div className='w-[60%] overflow-visible '>
                <div className=' bg-[url("/images/bg-intro-desktop.svg")] bg-contain bg-no-repeat w-full bg-right h-full  overflow-x-hidden overflow-y-visible'>
                </div>
                <img src="images/image-mockups.png" width="auto" height="auto" className='top-[-10%] ml-56 absolute' alt="" />
            </div>
        </div>
    )
}
