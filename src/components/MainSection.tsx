    ...
    return (
        <div className='lg:h-[100vh] pb-20 lg:pb-0 lg:pl-36 w-full flex lg:flex-row flex-col-reverse '>
            <div className='lg:w-[40%]  lg:mt-44 lg:scale-110 lg:text-left text-center '>
                ...
                <button name='invite-btn' className="mt-5 hover:from-green-300 hover:to-green-600 ml-auto bg-gradient-to-tr from-green-300 to-green-500 px-6 py-2 font-medium text-xs text-white rounded-2xl ">Request invite</button>
            </div>
